...
export default function Contact() {
    ...
    return (
        <div id="contact" className="flex flex-col items-center justify-center bg-gray-800 w-[100vw]">
            <h1 className="fadeHidden text-6xl pb-6 text-center">Contacts</h1>
            ...
            <form onSubmit={handleSubmit} action="" className="fadeHidden w-[60%] text-xl">
                ...
                <button type="submit" className="mt-1 mb-8 border-black border-solid border-2 bg-white hover:bg-gray-300 border-3 p-1 cursor-pointer rounded-md text-black">Submit</button>
            </form>
        </div>
    )
}